...
describe("Model", function () {
  ...
  describe("search()", function () {
    ...
    test("should return the search company name and handle ", async function () {
      ...
      expect(result).toEqual([{ "handle": "testHandle", "name": "testName" },{ "handle": "testHandle2", "name": "testName2" }])
    });
  ...
  describe("get()", function () {
    test("should return company details and jobs for that compnay when handle is valid",
      async function () {
        let result = await Company.getCompany("testHandle")
    ...
    test("should return company details",
      async function () {
        let result = await Company.getCompany("invalid");
